...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $areaOsakaId = DB::table('areas')->where('area_name', '大阪府')->value('id');
        $areaFukuokaId = DB::table('areas')->where('area_name', '福岡県')->value('id');
        // ジャンルID
        $genreSushiId = DB::table('genres')->where('genre_name', '寿司')->value('id');
        $genreYakinikuId = DB::table('genres')->where('genre_name', '焼肉')->value('id');
        $genreIzakayaId = DB::table('genres')->where('genre_name', '居酒屋')->value('id');
        $genreItariannId = DB::table('genres')->where('genre_name', 'イタリアン')->value('id');
        $genreRamenId = DB::table('genres')->where('genre_name', 'ラーメン')->value('id');
        ...
        DB::table('shops')->insert([
            ...
            [
                'user_id' => $userId,
                'shop_name' => '戦慄',
                'area_id' => $areaFukuokaId,
                'genre_id' => $genreIzakayaId,
